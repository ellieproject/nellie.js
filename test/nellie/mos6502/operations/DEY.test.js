...
test.beforeEach((t) => {
  ...
  t.context.OP = require('@ellieproject/nellie/mos6502/operations/DEY');
});
...
test('execute() should decrement Y', (t) => {
  ...
  t.is(MOS6502.register.y.get(), 0x00);
});

test.todo('how do we deal with decrement wraparound?');
