/* test/nellie/mos6502/operations/BCC/index.test.js
 *
 */
...
test.beforeEach((t) => {
  ...
  t.context.OP = require('@ellieproject/nellie/mos6502/operations/BCC');
});
...
test('execute() should alter PC when C is clear (add)', (t) => {
...
test('execute() should alter PC when C is clear (add page)', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.p.bitSet('C', 0);
...
test('execute() should alter PC when C is clear (sub)', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.p.bitSet('C', 0);
...
test('execute() should alter PC when C is clear (sub page)', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.p.bitSet('C', 0);
...
test('execute() should not alter PC when C is set', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
