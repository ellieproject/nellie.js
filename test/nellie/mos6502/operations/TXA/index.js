/* test/nellie/mos6502/operations/TXA/index.js
 *
 */
...
test.beforeEach((t) => {
  ...
  t.context.OP = require('@ellieproject/nellie/mos6502/operations/TXA');
});
...
test('execute() should set A from X', (t) => {
...
test('execute() should set N flag to 0', (t) => {
  ...
  MOS6502.register.x.set(0x00); // 7th bit 0
  t.context.OP.execute(MOS6502);
...
test('execute() should set N flag to 1', (t) => {
  ...
  MOS6502.register.x.set(0xF0); // 7th bit 1
  t.context.OP.execute(MOS6502);
...
test('execute() should set Z flag to 0', (t) => {
  ...
  MOS6502.register.x.set(0xFF); // not 0
  t.context.OP.execute(MOS6502);
