/* test/nellie/mos6502/operations/DEC/index.js
 *
 */
...
test('exec() ABSOLUTE_X mode should decrement memory', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
...
test('exec() ABSOLUTE mode should decrement memory', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.pc.set(0x0000);
...
test('exec() ZERO_PAGE_X mode should decrement memory', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.pc.set(0x0000);
...
test('exec() ZERO_PAGE mode should decrement memory', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.pc.set(0x0000);
  MOS6502.memory.main.data[0x0001] = 0xFF;
