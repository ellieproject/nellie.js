/* test/nellie/mos6502/operations/ROR.test.js
 *
 */
...
test.beforeEach((t) => {
  ...
  t.context.OP = require('@ellieproject/nellie/mos6502/operations/ROR');
});
...
test('execute() should rotate B right (no carry)', (t) => {
...
test('execute() should rotate B right (carry)', (t) => {
  const MOS6502 = t.context.MOS6502;
  MOS6502.register.p.bitSet('C', 1); // force to 1
  MOS6502.register.b.set(0b10101010);
  t.context.OP.execute(MOS6502);
  t.is(MOS6502.register.b.get(), 0b11010101);
});
