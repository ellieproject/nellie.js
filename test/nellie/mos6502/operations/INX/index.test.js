/* test/nellie/mos6502/operations/INX/index.test.js
 *
 */
...
test.beforeEach((t) => {
  ...
  t.context.OP = require('@ellieproject/nellie/mos6502/operations/INX');
});
...
test('execute() should increment X', (t) => {
...
test('run() IMPLIED mode should increment X', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.x.set(0x00);
