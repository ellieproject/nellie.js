/* test/nellie/mos6502/operations/INC/index.test.js
 *
 */
...
test('run() ABSOLUTE_X mode should increment memory', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
...
test('run() ABSOLUTE mode should increment memory', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.pc.set(0x0000);
...
test('run() ZERO_PAGE_X mode should increment memory', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.pc.set(0x0000);
...
test('run() ZERO_PAGE mode should increment memory', (t) => {
  const MOS6502 = t.context.MOS6502;
  const OP = t.context.OP;
  MOS6502.register.pc.set(0x0000);
  MOS6502.memory.main.data[0x0001] = 0xFF;
