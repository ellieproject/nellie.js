/* test/nellie/mos6502/operations/TAX/implied.test.js
 *
 * tests for the IMPLIED mode of the TAX operation
...
test.beforeEach((t) => {
  ...
  t.context.OP      = require('@ellieproject/nellie/mos6502/operations/TAX');
